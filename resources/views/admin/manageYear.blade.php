...
@section('content')
<div id="set">
<h2><img height="45" src="/img/setting.png">year</h2>
<div class="row">
		...
		<div class="col-xs-10 col-md-6 col-lg-4">
					...
					<small>Press <span class="glyphicon glyphicon-plus gs"></span> to add another year</small>
					</div>
	...
	<div class="cd-popup" role="alert">
	    <div class="cd-popup-container">
	       <p>This year cannot be deleted.</p>
