		...
		<table id="pjtable" class="table table-bordered" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{$pj->grade1 !== [] ? $pj->grade1 : ''}} <span class="{{$pj->class1}}">{{$pj->level1 !== null ? '('.$pj->level1.')' : ''}}</span></td>
					<td>{{$pj->grade2 !== [] ? $pj->grade2 : ''}} <span class="{{$pj->class2}}">{{$pj->level2 !== null ? '('.$pj->level2.')' : ''}}</span></td>
					<td>{{$pj->grade3 !== [] ? $pj->grade3 : ''}} <span class="{{$pj->class3}}">{{$pj->level3 !== null ? '('.$pj->level3.')' : ''}}</span></td>
					<td>{{$pj->grade4 !== [] ? $pj->grade4 : ''}} <span class="{{$pj->class4}}">{{$pj->level4 !== null ? '('.$pj->level4.')' : ''}}</span></td>
				</tr>
				@endforeach
			</tbody>
    	</table>
